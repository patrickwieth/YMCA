...
namespace OpenRA.Mods.Common.Projectiles
{
    ...
    public readonly WVec targetOffset = new WVec(0, 0, 0);
		...
		public IProjectile Create(ProjectileArgs args)
		{
			...
			return new RailgunCA(args, this, bc, hc);
		}
	}

	public class RailgunCA : IProjectile, ISync
	{
		...
		// Computing these in RailgunCA instead of RailgunCARenderable saves Info.Duration ticks of computation.
		// Fortunately, RailgunCAs don't track the target.
		...
		public RailgunCA(ProjectileArgs args, RailgunCAInfo info, Color beamColor, Color helixColor)
		{
			this.args = args;
			this.info = info;
		...
		void CalculateVectors()
		{
			...
			SourceToTarget = target - args.Source + info.targetOffset;
			...
			// Trade-off between computation vs RailgunCA weapon range.
			// Modders must not have too large range for RailgunCA weapons.
