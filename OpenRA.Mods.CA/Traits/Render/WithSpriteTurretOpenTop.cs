...
namespace OpenRA.Mods.CA.Traits.Render
{
	...
	public class WithSpriteTurretOpenTopInfo : ConditionalTraitInfo, IRenderActorPreviewSpritesInfo,
		Requires<RenderSpritesInfo>, Requires<TurretedOpenTopInfo>, Requires<BodyOrientationInfo>, Requires<ArmamentInfo>
	{
		[SequenceReference]
		...
		public override object Create(ActorInitializer init) { return new WithSpriteTurretOpenTop(init.Self, this); }
		...
		public IEnumerable<IActorPreview> RenderPreviewSprites(ActorPreviewInitializer init, RenderSpritesInfo rs, string image, int facings, PaletteReference p)
		{
			...
			var t = init.Actor.TraitInfos<TurretedOpenTopInfo>()
	...
	public class WithSpriteTurretOpenTop : ConditionalTrait<WithSpriteTurretOpenTopInfo>, INotifyDamageStateChanged
	{
		public readonly Animation DefaultAnimation;
		readonly RenderSprites rs;
		readonly BodyOrientation body;
		readonly TurretedOpenTop t;
		readonly Armament[] arms;

		public WithSpriteTurretOpenTop(Actor self, WithSpriteTurretOpenTopInfo info)
			: base(info)
		{
			rs = self.Trait<RenderSprites>();
			body = self.Trait<BodyOrientation>();
			t = self.TraitsImplementing<TurretedOpenTop>()
