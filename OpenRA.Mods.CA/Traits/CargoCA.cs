...
namespace OpenRA.Mods.CA.Traits
{
	...
	public class CargoCAInfo : ITraitInfo, Requires<IOccupySpaceInfo>
	{
		...
		public object Create(ActorInitializer init) { return new CargoCA(init, this); }
	}

	public class CargoCA : IIssueOrder, IResolveOrder, IOrderVoice, INotifyCreated, INotifyKilled,
		INotifyOwnerChanged, INotifySold, INotifyActorDisposing, IIssueDeployOrder,
		ITransformActorInitModifier
	{
		public readonly CargoCAInfo Info;
		readonly Actor self;
		...
		public CargoCA(ActorInitializer init, CargoInfo info)
		{
			self = init.Self;
			Info = info;
