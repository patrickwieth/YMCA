...
- Outstanding: visual match vs. OS SHP cameo generator still needs user confirmation; banner darkness/position/kerning/line-break (wrap >14 chars into up to 2 lines at last space) are adjustable via ProductionIconButtonizer styles.
