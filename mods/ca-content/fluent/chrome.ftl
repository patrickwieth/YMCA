modcontent-installprompt =
    Additional soundtrack packages are available for download.

modcontent-header =
    You can download the optional Red Alert and C&C franchise music packs, as well as the custom YMCA soundtrack.
