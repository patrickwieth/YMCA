param(
	[string]$Source = "$env:APPDATA/../Roaming/OpenRA/Content/ca/cnc/scores.mix",
	[string]$Output = "packaging/cnc-music.zip"
)
...
if (-not $sourcePath)
{
	throw "Could not find C&C music at '$Source'. Install C&C scores.mix first."
}
